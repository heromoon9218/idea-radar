...
- **Sprint 名を勝手に命名しない**: SPEC.md に未着手の Sprint 枠（現在は Sprint C = distribution_hypothesis / semantic dedup）が予約されている。新しい作業に "Sprint X" を付けるときは SPEC.md の予約状況を確認してから命名する。該当スコープでない ad-hoc 対応は Sprint 名を付けず、日付 / 機能名で書く（例: "SE 主要化", "2026-04 のソース入替"）
