...
// 2026-04-29 引き上げ: aggregator は 3→5、combinator pain+info 合計 2→3 に上げて
// 弱いクラスタを drafter に渡さない (drafter コストの割に PASS 率が低かったため)。
const AGGREGATOR_MIN_SIGNALS = 5;
...
//   - その他: 2 件以上 (単独だと弱いネタ元が多いため)
const GAP_MIN_SIGNALS_PRIMARY = 1; // launch_hn / show_hn
const GAP_MIN_SIGNALS_SECONDARY = 2; // paid_service_mention / niche_transfer / other
